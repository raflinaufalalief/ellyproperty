          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
            <div className="absolute w-auto mx-auto my-6 top-2 mobile:w-full mobile:px-2 Sdesktop:max-w-6xl">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                {/*body*/}
                <div className=" flex-auto p-6 Sdesktop:w-[500px] Sdesktop:h-vit">
                  <div className="">
                    <div className="flex items-center justify-between border-t-2 border-black/20">
                      <h1 className="text-sm font-medium mobile:py-4 Sdesktop:py-1 text-black/70">
                        Kamar Tidur
                      </h1>
                      <h2 className="text-sm font-medium mobile:py-4 Sdesktop:py-1 text-black/60 ">
                        {myData.kt}
                      </h2>
                    </div>
                    <div className="flex items-center justify-between border-t-2 border-black/20">
                    ...
                    <div className="flex items-center justify-between border-t-2 border-black/20">
                      ...
                      <h2 className="mobile:py-4 Sdesktop:py-1 text-sm font-medium w-[10rem] text-right text-black/60 ">
