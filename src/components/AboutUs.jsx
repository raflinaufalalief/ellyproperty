      ...
      <div className="mx-auto containers">
        <div className="flex flex-wrap gap-10 mobile:px-3 mobile:text-center">
          ...
          <div className="relative flex-1 basis-[22rem]">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-8">
              <div>
                <p className="mt-6 text-xl font-semibold leading-5 text-gray-800 Sdesktop:text-2xl Sdesktop:leading-6">
                  Founded
                </p>
            ...
            <div className="flex flex-col justify-between gap-16 mt-16 Sdesktop:flex-row md:gap-14 Sdesktop:mt-20">
              <div className="w-full Sdesktop:w-6/12">
                <h2 className="text-3xl font-bold leading-7 text-gray-800 Sdesktop:text-4xl Sdesktop:leading-9">
                  Our Mission
                </h2>
                <p className="w-full mt-6 text-base font-normal leading-6 text-gray-600 Sdesktop:w-10/12 xl:w-9/12">
                  It is a long established fact that a reader will be distracted
                  by the readable content of a page when looking at its layout.
                ...
                <p className="w-full mt-10 text-base font-normal leading-6 text-gray-600 Sdesktop:w-10/12 xl:w-9/12">
                  It is a long established fact that a reader will be distracted
                  by the readable content of a page when looking at its layout.
                  The point of using Lorem Ipsum.In the first place we have
                  granted to God, and by this our present charter confirmed for
              ...
              <div className="w-full Sdesktop:w-6/12">
                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 Sdesktop:grid-cols-1 Sdesktop:gap-12">
                  {/* <!-- Team Card --> */}
                  <div className="flex p-4 shadow-md">
                    ...
                    <div className="">
                      <p className="text-xl font-semibold leading-5 text-gray-800 Sdesktop:text-2xl Sdesktop:leading-6">
                        Team
                      </p>
