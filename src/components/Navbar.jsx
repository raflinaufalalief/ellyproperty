      ...
      <div className="py-5 containers mobile:mx-4 tablet:mx-6">
        <div className="flex justify-between Sdesktop:items-center">
          ...
          <nav className="flex items-center">
            ...
            <ul>
              <div
                className={`transition-all bg-white ease-in-out duration-200 mobile:absolute mobile:mt-10 mobile:w-full mobile:p-4 tablet:absolute Sdesktop:flex Sdesktop:gap-x-9 Sdesktop:items-center tablet:w-full tablet:mt-10 tablet:p-5 z-20 ${
              ...
              >
                {dataNavLink.map((result, index) => (
                  <li
                    onClick={() => setMenu((prev) => !prev)}
                    key={index}
                    className="text-lg font-normal list hover:text-accent mobile:space-y-3 mobile:my-3 tablet:my-4"
                  >
