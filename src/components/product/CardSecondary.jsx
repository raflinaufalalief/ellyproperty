...
//             <h1 className="text-xl font-semibold text-black/90">Secondary</h1>
...
//                         <Link to="/product">
//                           <button className="inline-flex px-3 py-2 text-sm font-medium text-white rounded-lg select-none bg-accent">
//                             view detail
//                           </button>
//                         </Link>
//                       </div>
