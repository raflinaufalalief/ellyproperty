    ...
    <div className="pb-20">
      <div className="mx-auto bg-gray-200 containers ">
        <div className="pb-8 bg-white rounded-lg shadow-xl">
          ...
          <div className="flex flex-col items-center justify-end flex-1 px-8 mt-2 Sdesktop:items-end">
        ...
        <div className="flex flex-col my-4 space-y-4 2xl:flex-row 2xl:space-y-0 2xl:space-x-4">
          <div className="flex flex-col w-full 2xl:w-1/3">
            <div className="flex-1 p-8 bg-white shadow-xl rounded-">
            ...
            <div className="flex-1 p-8 mt-4 bg-white shadow-xl rounded-">
