  ...
  return (
    <section>
      <div class="mx-auto containers">
        <div class="relative h-56 rounded-b-Sdesktop bg-cover bg-center bg-no-repeat shadow-Sdesktop bg-accent/40">
          <div class="px-4 pt-8 pb-10">
            <div class="absolute inset-x-0 -bottom-10 mx-auto w-36 rounded-full border-8 border-white shadow-Sdesktop">
        ...
        <div class="mt-10 flex flex-col items-start justify-center space-y-4 py-8 px-4 sm:flex-row sm:space-y-0 md:justify-between Sdesktop:px-0">
          <div class="max-w-Sdesktop">
          ...
          <div class="">
            <button class="flex whitespace-nowrap rounded-Sdesktop bg-pink-600 px-6 py-2 font-bold text-white transition hover:translate-y-1">
              <svg
        ...
        <main class="grid grid-cols-2 gap-x-6 gap-y-10 px-2 pb-20 sm:grid-cols-3 sm:px-8 Sdesktop:mt-16 Sdesktop:grid-cols-4 Sdesktop:gap-x-4 Sdesktop:px-0">
          <div class="relative">
